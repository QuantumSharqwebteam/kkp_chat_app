...
class ChatRepository {
  ...
  //fetch inquiry formdata for the specific agent
  Future<List<FormDataModel>> fetchFormDataByAgent(String agentEmail) async {
    return await chatService.getFormDataByUser(email: agentEmail);
  }
